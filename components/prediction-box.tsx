...
export default function PredictionBox({ match }: any) {
  ...
  return (
    <Card className="bg-gradient-to-br from-accent/20 to-accent/5 border-accent/50 overflow-hidden">
      <CardContent className="pt-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-accent mb-2">{prediction.winner}</h2>
